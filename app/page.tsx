  ...
  return (
    <>
      <div className="relative flex flex-col min-h-screen bg-white font-sans">
              ...
              <div className="flex flex-col-reverse items-center justify-center md:flex-row items-left">
                <div className="md:w-1/2 text-left md:text-left mb-8 md:mb-0">
                  ...
                  <p className="text-xl relative z-10 md:text-l text-[#5f6368] mb-8">
                    ...
                    Whether youre here to learn, lead, or create, our vibrant
                    community is here to help you thrive. Participate in our
                    technical events, and you might even grab some cool
                    goodies—we believe every achievement deserves a little
                    celebration. Your journey starts here, join us today!
                  </p>
        ...
        <footer className="bg-[#202124] py-4">
          {/* Empty black footer */}
        </footer>
      </div>
      <Image
