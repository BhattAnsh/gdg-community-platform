...
const teamMembers = [
  {
    ...
    position: "Organiser",
    description:
      "Ensuring smooth coordination and success of all club activities",
    image: "/kartikeya.jpg",
  },
  {
    name: "Vivek Mishra",
  ...
  },
  {
    ...
    position: "AI-ML Lead",
    description:
      "Leading our community’s AI/ML initiatives with innovative projects.",
    image: "/sudipta.jpg",
  },
  {
    ...
    description:
      "I support AI/ML development and knowledge-sharing within the team.",
    image: "/nishchay.jpg",
  },
  {
    ...
    position: "Web Lead",
    description:
      "As the Web Lead, I spearhead web development efforts to deliver impactful solutions.",
    image: "/shreya.jpg",
  },
  {
    name: "Ansh Bhatt",
  ...
  },
  {
    ...
    description:
      "I drive mobile app development and engage the community in Android initiatives.",
    image: "/swati.jpg",
  },
  {
    name: "Harsh Kumar",
    position: "Cloud Lead",
    description:
      "I empower the community to explore the limitless possibilities of cloud computing.",
    image: "/harsh.jpg",
  },
  {
    name: "Abhinav Jain",
    ...
    description:
      "Creating visually appealing designs for events and promotions.",
    image: "/abhinav.jpg",
  },
  {
    name: "Kanika Sharma",
    ...
    description:
      "I support in designing captivating visual content for the club.",
    image: "/kanika.jpg",
  },
];
...
export default function Team() {
  ...
  useEffect(() => {
    ...
    const scroll = () => {
      ...
      if (
        scrollPosition <= 0 ||
        scrollPosition >= scrollContainer.scrollWidth - container.clientWidth
      ) {
        scrollDirection *= -1;
      }
  ...
  return (
    <section id="team" className="py-20 md:py-32 bg-gray-50" ref={containerRef}>
      <div className="container mx-auto px-4">
        <u className="text-[#fbbc05]">
          <h2 className="text-3xl md:text-5xl font-[700] text-center mb-12 text-[#fbbc05]">
            Meet the Team
          </h2>
        </u>
        <div
